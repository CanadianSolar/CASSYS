VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} UF_AddSameInverterOptions 
   Caption         =   "CASSYS Import existing inverter"
   ClientHeight    =   2490
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   7350
   OleObjectBlob   =   "UF_AddSameInverterOptions.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "UF_AddSameInverterOptions"
...
Public Sub CommandButton1_Click()
    choiceType = 1
    UF_AddSameInverterOptions.Hide
End Sub
